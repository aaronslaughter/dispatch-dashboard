...
export default function TicketListItem(props) {
  return (
    <div className="ticket-list-item">
      ...
      <p>{props.ticket.assignedTech ? 
        props.technicians.find((element) => element._id === props.ticket.assignedTech).firstName + ' ' + 
        props.technicians.find((element) => element._id === props.ticket.assignedTech).lastName : 
        'Not Assigned'}</p>
